...
export const metadata = {
  ...
  description: "Discover authentic antique auctions from our expertly curated collection. Premium quality, worldwide shipping, and certificate of authenticity included.",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1614596896028-de93b23b60a8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxhbnRpcXVlJTIwYXVjdGlvbnN8ZW58MHwwfHx8MTc1NzM0MDkwOXww&ixlib=rb-4.1.0&q=80&w=1080",
        width: 1200,
        height: 630,
        alt: "antique auctions - brown wooden chest with brass and silver tools"
      }
    ]
  },
  twitter: {
    ...
    title: "Antique Auctions | NY Elizabeth Auctions",
    description: "Discover authentic antique auctions from our expertly curated collection. Premium quality, worldwide shipping, and certificate of authenticity included.",
    images: ["https://images.unsplash.com/photo-1614596896028-de93b23b60a8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxhbnRpcXVlJTIwYXVjdGlvbnN8ZW58MHwwfHx8MTc1NzM0MDkwOXww&ixlib=rb-4.1.0&q=80&w=1080"]
  }
};
...
export default function AntiqueAuctionsPage() {
  ...
  "datePublished": "2025-09-08T14:15:15.547Z",
  "dateModified": "2025-09-08T14:15:15.566Z",
  "image": [
    "https://images.unsplash.com/photo-1614596896028-de93b23b60a8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxhbnRpcXVlJTIwYXVjdGlvbnN8ZW58MHwwfHx8MTc1NzM0MDkwOXww&ixlib=rb-4.1.0&q=80&w=1080",
      ...
      <section className="py-12 md:py-20 mt-[80px] bg-gradient-to-b from-gray-50 to-white overflow-hidden">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="relative h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="https://images.unsplash.com/photo-1614596896028-de93b23b60a8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxhbnRpcXVlJTIwYXVjdGlvbnN8ZW58MHwwfHx8MTc1NzM0MDkwOXww&ixlib=rb-4.1.0&q=80&w=1080"
                alt="antique auctions - brown wooden chest with brass and silver tools"
                fill
                ...
                <div className="my-8">
                  <div className="relative h-80 rounded-xl overflow-hidden shadow-lg">
                    <Image
                      ...
                      alt="antique auctions - books on brown wooden shelf"
                      fill
                      className="object-cover"
