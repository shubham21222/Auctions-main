...
export const metadata = {
  ...
  description: "Find exceptional jewellery shops in our exclusive collection. Museum-quality pieces, expert authentication, and worldwide delivery available.",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1634996601533-3c1ada264daf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxqZXdlbGxlcnklMjBzaG9wc3xlbnwwfDB8fHwxNzU3MzQwOTUyfDA&ixlib=rb-4.1.0&q=80&w=1080",
        width: 1200,
        height: 630,
        alt: "jewellery shops - a man is standing in front of a building"
      }
    ]
  },
  twitter: {
    ...
    title: "Jewellery Shops | NY Elizabeth Auctions",
    description: "Find exceptional jewellery shops in our exclusive collection. Museum-quality pieces, expert authentication, and worldwide delivery available.",
    images: ["https://images.unsplash.com/photo-1634996601533-3c1ada264daf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxqZXdlbGxlcnklMjBzaG9wc3xlbnwwfDB8fHwxNzU3MzQwOTUyfDA&ixlib=rb-4.1.0&q=80&w=1080"]
  }
};
...
export default function JewelleryShopsPage() {
  ...
  "image": [
    "https://images.unsplash.com/photo-1634996601533-3c1ada264daf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxqZXdlbGxlcnklMjBzaG9wc3xlbnwwfDB8fHwxNzU3MzQwOTUyfDA&ixlib=rb-4.1.0&q=80&w=1080",
      ...
      <section className="py-12 md:py-20 mt-[80px] bg-gradient-to-b from-gray-50 to-white overflow-hidden">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="relative h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="https://images.unsplash.com/photo-1634996601533-3c1ada264daf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxqZXdlbGxlcnklMjBzaG9wc3xlbnwwfDB8fHwxNzU3MzQwOTUyfDA&ixlib=rb-4.1.0&q=80&w=1080"
                alt="jewellery shops - a man is standing in front of a building"
                fill
            ...
            <article className="prose prose-lg mx-auto">
              ...
              <section className="mt-12">
                <p className="text-lg text-gray-700 leading-relaxed">
                  Our commitment to excellence in jewellery shops extends beyond mere transaction to encompass education, authentication, and ongoing collector support. Each piece represents not only an aesthetic achievement but also a sound investment in cultural heritage and artistic legacy.
                </p>
              </section>
            </article>
          </div>
