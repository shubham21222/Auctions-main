...
export const metadata = {
  ...
  description: "Find exceptional online antique auctions in our exclusive collection. Museum-quality pieces, expert authentication, and worldwide delivery available.",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.pexels.com/photos/4754688/pexels-photo-4754688.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Online Antique Auctions | NY Elizabeth Auctions",
    description: "Find exceptional online antique auctions in our exclusive collection. Museum-quality pieces, expert authentication, and worldwide delivery available.",
    images: ["https://images.pexels.com/photos/4754688/pexels-photo-4754688.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  }
};
...
export default function OnlineAntiqueAuctionsPage() {
  ...
  "@type": "Article",
  "headline": "Premium Online Antique Auctions",
  "description": "Find exceptional online antique auctions in our exclusive collection. Museum-quality pieces, expert authentication, and worldwide delivery available.",
  "author": {
    "@type": "Organization",
    "name": "NY Elizabeth Auctions"
  },
  "datePublished": "2025-09-08T13:22:53.757Z",
  "dateModified": "2025-09-08T13:22:53.757Z",
  "image": [
              ...
              <div className="my-8">
                <div className="relative h-80 rounded-xl overflow-hidden shadow-lg">
                  <Image
                    ...
                    alt="online antique auctions - Premium artwork collection"
                    fill
                    className="object-cover"
                    sizes="(max-width: 768px) 100vw, 800px"
                  />
