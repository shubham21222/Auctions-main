...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.pexels.com/photos/33814470/pexels-photo-33814470.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Vintage Furniture Auction | NY Elizabeth Auctions",
    description: "Explore rare vintage furniture auction at NY Elizabeth Auctions. Handpicked by experts, authenticated pieces with provenance. Shop with confidence today.",
    images: ["https://images.pexels.com/photos/33814470/pexels-photo-33814470.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  }
};
...
export default function VintageFurnitureAuctionPage() {
  ...
  "@type": "Article",
  "headline": "Premium Vintage Furniture Auction",
  "description": "Explore rare vintage furniture auction at NY Elizabeth Auctions. Handpicked by experts, authenticated pieces with provenance. Shop with confidence today.",
  "author": {
    "@type": "Organization",
    "name": "NY Elizabeth Auctions"
  },
  "datePublished": "2025-09-08T13:23:16.400Z",
  "dateModified": "2025-09-08T13:23:16.400Z",
  "image": [
            ...
            <article className="prose prose-lg mx-auto">
              ...
              <section className="mt-12">
                <p className="text-lg text-gray-700 leading-relaxed">
                  Our commitment to excellence in vintage furniture auction extends beyond mere transaction to encompass education, authentication, and ongoing collector support. Each piece represents not only an aesthetic achievement but also a sound investment in cultural heritage and artistic legacy.
                </p>
              </section>
            </article>
          </div>
