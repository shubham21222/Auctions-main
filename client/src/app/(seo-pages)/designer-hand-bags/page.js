...
export const metadata = {
  ...
  description: "Discover authentic designer hand bags from our expertly curated collection. Premium quality, worldwide shipping, and certificate of authenticity included.",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1601924921557-45e6dea0a157?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxkZXNpZ25lciUyMGhhbmQlMjBiYWdzfGVufDB8MHx8fDE3NTczNDA5MjB8MA&ixlib=rb-4.1.0&q=80&w=1080",
        width: 1200,
        height: 630,
        alt: "designer hand bags - red and white sling bag"
      }
    ]
  },
  twitter: {
    ...
    title: "Designer Hand Bags | NY Elizabeth Auctions",
    description: "Discover authentic designer hand bags from our expertly curated collection. Premium quality, worldwide shipping, and certificate of authenticity included.",
    images: ["https://images.unsplash.com/photo-1601924921557-45e6dea0a157?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxkZXNpZ25lciUyMGhhbmQlMjBiYWdzfGVufDB8MHx8fDE3NTczNDA5MjB8MA&ixlib=rb-4.1.0&q=80&w=1080"]
  }
};
...
export default function DesignerHandBagsPage() {
  ...
  "@type": "Article",
  "headline": "Designer Hand Bags",
  "description": "Discover authentic designer hand bags from our expertly curated collection. Premium quality, worldwide shipping, and certificate of authenticity included.",
  "author": {
    "@type": "Organization",
    "name": "NY Elizabeth Auctions"
  },
  "datePublished": "2025-09-08T14:15:23.591Z",
  "dateModified": "2025-09-08T14:15:23.610Z",
  "image": [
    "https://images.unsplash.com/photo-1601924921557-45e6dea0a157?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxkZXNpZ25lciUyMGhhbmQlMjBiYWdzfGVufDB8MHx8fDE3NTczNDA5MjB8MA&ixlib=rb-4.1.0&q=80&w=1080",
      ...
      <section className="py-12 md:py-20 mt-[80px] bg-gradient-to-b from-gray-50 to-white overflow-hidden">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="relative h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="https://images.unsplash.com/photo-1601924921557-45e6dea0a157?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxkZXNpZ25lciUyMGhhbmQlMjBiYWdzfGVufDB8MHx8fDE3NTczNDA5MjB8MA&ixlib=rb-4.1.0&q=80&w=1080"
                alt="designer hand bags - red and white sling bag"
                fill
            ...
            <article className="prose prose-lg mx-auto">
              ...
              <section className="my-12 p-6 bg-gray-50 rounded-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Link href="/designer-bags-outlet" className="block p-4 bg-white rounded-lg shadow hover:shadow-md transition-shadow">
                    <span className="text-blue-600 hover:text-blue-800 font-medium">
                      authentic designer bags outlet
                    </span>
                  </Link>
              ...
              <section className="mt-12">
                <p className="text-lg text-gray-700 leading-relaxed">
                  The exceptional quality and authenticity of our designer hand bags collection reflect decades of expertise in identifying and acquiring remarkable works. We invite discerning collectors to explore these extraordinary pieces and discover the perfect additions to their collections.
                </p>
              </section>
            </article>
          </div>
