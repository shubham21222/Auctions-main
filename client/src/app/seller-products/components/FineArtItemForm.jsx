...
const FineArtItemForm = ({ setCurrentStep, selectedCategory, formData, setFormData }) => {
  const [general, setGeneral] = useState({
    countryOrigin: formData.General?.countryOrigin || "",
    Artist: formData.General?.Artist || "",
    object: formData.General?.object || "Artwork",
  ...
  const handleSubmit = (e) => {
    ...
    setCurrentStep(3);
    toast.success("Fine Art details saved!");
  };

  return (
    <div className="max-w-6xl mt-[80px] mx-auto bg-white p-6 rounded-xl shadow-lg">
      <h1 className="text-3xl font-bold text-center mb-6 text-gray-800">Fine Art Details</h1>
...
export default FineArtItemForm;