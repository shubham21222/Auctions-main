...
export const metadata = {
  ...
  description: "Find exceptional ancient art in our exclusive collection. Museum-quality pieces, expert authentication, and worldwide delivery available.",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1580136579395-4bbb9ffdc4ca?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxhbmNpZW50JTIwYXJ0fGVufDB8MHx8fDE3NTczNDA5MDF8MA&ixlib=rb-4.1.0&q=80&w=1080",
        width: 1200,
        height: 630,
        alt: "ancient art - a painting of a group of men on horses"
      }
    ]
  },
  twitter: {
    ...
    title: "Ancient Art | NY Elizabeth Auctions",
    description: "Find exceptional ancient art in our exclusive collection. Museum-quality pieces, expert authentication, and worldwide delivery available.",
    images: ["https://images.unsplash.com/photo-1580136579395-4bbb9ffdc4ca?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxhbmNpZW50JTIwYXJ0fGVufDB8MHx8fDE3NTczNDA5MDF8MA&ixlib=rb-4.1.0&q=80&w=1080"]
  }
};
...
export default function AncientArtPage() {
  ...
  "@type": "Article",
  "headline": "Premium Ancient Art",
  "description": "Find exceptional ancient art in our exclusive collection. Museum-quality pieces, expert authentication, and worldwide delivery available.",
  "author": {
    "@type": "Organization",
    "name": "NY Elizabeth Auctions"
  },
  "datePublished": "2025-09-08T14:15:04.334Z",
  "dateModified": "2025-09-08T14:15:04.334Z",
  "image": [
    "https://images.unsplash.com/photo-1580136579395-4bbb9ffdc4ca?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxhbmNpZW50JTIwYXJ0fGVufDB8MHx8fDE3NTczNDA5MDF8MA&ixlib=rb-4.1.0&q=80&w=1080",
      ...
      <section className="py-12 md:py-20 mt-[80px] bg-gradient-to-b from-gray-50 to-white overflow-hidden">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="relative h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="https://images.unsplash.com/photo-1580136579395-4bbb9ffdc4ca?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NzU4MDl8MHwxfHNlYXJjaHwxfHxhbmNpZW50JTIwYXJ0fGVufDB8MHx8fDE3NTczNDA5MDF8MA&ixlib=rb-4.1.0&q=80&w=1080"
                alt="ancient art - a painting of a group of men on horses"
                fill
            ...
            <article className="prose prose-lg mx-auto">
              ...
              <section className="mt-12">
                <p className="text-lg text-gray-700 leading-relaxed">
                  The exceptional quality and authenticity of our ancient art collection reflect decades of expertise in identifying and acquiring remarkable works. We invite discerning collectors to explore these extraordinary pieces and discover the perfect additions to their collections.
                </p>
              </section>
            </article>
          </div>
